const MenuChoice: React.FC = () => {
	return (
		<div className='relative flex flex-wrap h-[150vh] w-full'>
			<div className='relative flex items-center justify-center w-1/2 h-1/2 bg-pizza bg-cover bg-top'>
			...
			<div className='relative flex items-center justify-center w-1/2 h-1/2 bg-burger bg-cover bg-center'>
			...
			<div className='relative flex items-center justify-center w-1/2 h-1/2 bg-drink bg-cover bg-center'>
			...
			<div className='relative flex items-center justify-center w-1/2 h-1/2 bg-taco bg-cover bg-center'>
				<div className='absolute inset-0 bg-indigo-600 opacity-0 hover:opacity-100 transition-opacity duration-300'></div>
				<p className='text-8xl uppercase z-10'>Tacos</p>
			</div>
		</div>
	);
};
